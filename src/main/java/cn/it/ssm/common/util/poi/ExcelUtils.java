package cn.it.ssm.common.util.poi;

import cn.it.ssm.common.util.poi.convert.ExportConvert;
import cn.it.ssm.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
    ...
    public boolean toExcel(List<?> data, String sheetName, ExportHandler handler, OutputStream out) {
        ...
        // 导出列查询。
        ExcelExport currentExcelExport = null;
